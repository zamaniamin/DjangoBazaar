...
option_items_router.register("optionItems", OptionItemViewSet, basename="option-items")

urlpatterns = router.urls + products_router.urls + cart_items_router.urls + option_items_router.urls
